                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <form class="custom-validation" enctype="multipart/form-data" action="{{ route('user.store') }}"
                                method="post">
                                @csrf
                                <div class="card-body">
                                    {{-- <div class="">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <input type="text" value="{{ old('email') }}" class="form-control length_count"
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <input type="text" value="{{ old('mobile_no') }}"
                                    ...
                                    <div class="mt-3">
                                        <label class="form-label">Password (Equal To)<span
