                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <form class="custom-validation" enctype="multipart/form-data"
                                action="{{ route('role.update', ['role' => $role->id]) }}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="card-body">
                                    <div class="mt-3">
                                        <label class="mb-1">Role Name <span class="text-danger">*</span></label>
                                        <input type="text" name="name" value="{{ $role->name }}" maxlength="255"
                                                            ...
                                                            <li style="font-size: 15px;list-style-type: none">
                                                                ...
                                                                <div class="icheck-success">
                                                                    <input type="checkbox"
                                                                        ...
                                                                        {{ in_array($childrenItem->id, $role->permissions->pluck('id')->toArray()) ? 'checked' : '' }}>
